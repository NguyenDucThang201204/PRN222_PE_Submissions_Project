...
public partial class Fa25bearDbContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=laptop-g7btclnq;Initial Catalog=FA25BearDB;User Id=sa;Password=12345;Trust Server Certificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__BearAcco__349DA586C03F06C1");
        ...
        {
            entity.HasKey(e => e.BearProfileId).HasName("PK__BearProf__17E64CF75D1E0964");
        ...
        {
            entity.HasKey(e => e.BearTypeId).HasName("PK__BearType__ECEEBC34CD05B3C6");
