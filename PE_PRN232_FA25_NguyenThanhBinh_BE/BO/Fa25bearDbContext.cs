...
public partial class Fa25bearDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__BearAcco__349DA586F0F06177");
        ...
        {
            entity.HasKey(e => e.BearProfileId).HasName("PK__BearProf__17E64CD78D39B5AF");
        ...
        {
            entity.HasKey(e => e.BearTypeId).HasName("PK__BearType__ECEEBC14D5F62A31");
