...
//        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-IVTKGI7B;Initial Catalog=FA25BearDb;Persist Security Info=True;User ID=sa;Password=Duonggaming1@;Encrypt=False");
