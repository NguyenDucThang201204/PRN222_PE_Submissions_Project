...
namespace Bear.Repositories.DBContext;
...
public partial class FA25BearDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__BearAcco__349DA58645FAE39E");
        ...
        {
            entity.HasKey(e => e.BearProfileId).HasName("PK__BearProf__17E64CD7D36E4AB3");
        ...
        {
            entity.HasKey(e => e.BearTypeId).HasName("PK__BearType__ECEEBC145500443B");
