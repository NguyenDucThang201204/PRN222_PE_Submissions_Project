...
public partial class FA25BearDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__BearAcco__349DA5869917699C");
        ...
        {
            entity.HasKey(e => e.BearProfileId).HasName("PK__BearProf__17E64CD76DF13264");
        ...
        {
            entity.HasKey(e => e.BearTypeId).HasName("PK__BearType__ECEEBC143C418BF2");
