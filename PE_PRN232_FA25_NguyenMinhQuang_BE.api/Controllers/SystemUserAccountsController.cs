...
namespace PE_PRN232_FA25_NguyenMinhQuang_BE.api.Controllers
{
    ...
    public class SystemUserAccountsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequest request)
        {
            ...
            if (user == null)
            {
                return StatusCode(401, new { errorCode = "HB40101", message = "Invalid UserName(Email) or password" });
            }
        ...
        private string GenerateJSONWebToken(BearAccount systemAccount)
        {
            if (systemAccount.RoleId != 1 && systemAccount.RoleId != 2 && systemAccount.RoleId != 3 && systemAccount.RoleId != 4
                && systemAccount.RoleId != 5 && systemAccount.RoleId != 6 && systemAccount.RoleId != 7)
            {
                return string.Empty;
            }
            ...
            var token = new JwtSecurityToken(_config["Jwt:Issuer"]
                    ...
                    , new Claim[]
                    {
                    new(ClaimTypes.Name, systemAccount.FullName),
